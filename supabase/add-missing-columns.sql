...
alter table if exists public.vehicles add column if not exists first_verification_status text default 'pendiente';
alter table if exists public.vehicles add column if not exists second_verification_due date;
alter table if exists public.vehicles add column if not exists second_verification_status text default 'pendiente';
alter table if exists public.vehicles add column if not exists next_service_km numeric;
alter table if exists public.vehicles add column if not exists next_service_status text default 'pendiente';
...
alter table if exists public.drivers add column if not exists contract_start date;
alter table if exists public.drivers add column if not exists contract_end date;
alter table if exists public.drivers add column if not exists contract_renewal_date date;
